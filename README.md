...
# Pin a tag
curl -fsSL https://raw.githubusercontent.com/sina-parsania/flow-download-manager/main/Scripts/install.sh | bash -s -- --tag v0.3.1
...
**v0.3.1** is the current documented release — menu-bar agent, Chrome companion polish, resilient transfer engine, library UX, and Sparkle in-app updates (manual check by default). See [CHANGELOG.md](CHANGELOG.md).
